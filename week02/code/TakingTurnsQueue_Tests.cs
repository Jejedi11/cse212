...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The PersonQueue class method of Enque was inserting at index 0 putting them at the front of the list.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The GetNextPerson method had no logic for players with turns 0 or less, meaning they would leave the queue.
